...
const Social = () => {
  ...
  const socialLinks = [
    { link: "https://youtube.com", icon: <FaYoutube size={iconSize} color="#2C2E43" /> },
    { link: "https://instagram.com", icon: <FaInstagram size={iconSize} color="#2C2E43" /> },
    { link: "https://telegram.org", icon: <FaTelegram size={iconSize} color="#2C2E43" /> },
